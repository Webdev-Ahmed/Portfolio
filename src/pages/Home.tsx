...
const Home = () => {
  return (
    <>
      <PageSection className="w-full relative h-[80vh] max-1440:h-[75vh] max-768:h-[clamp(500px,_100vw,_70vh)] max-480:h-[75vh]">
        ...
        {isMobile({ width: "480px" }) ? (
          <motion.div
            ...
            className="flex items-end justify-center w-full h-full max-768:px-6 max-990:px-12"
          >
            <div className="w-[80%] h-[80%] max-768:h-[clamp(50%,_100vh,_80%)] max-990:w-[100%] max-990:h-[75%] max-1440:w-[850px] bg-neutral-800/35 border-[1px] p-2 pb-0 border-neutral-100/10 rounded-3xl rounded-b-none shadow-center-md shadow-neutral-950/75 bottom-0">
              <div className="w-full h-full relative border border-neutral-100/50 rounded-2xl bg-[#101010] overflow-hidden rounded-b-none">
                ...
                <div className="relative z-10 flex items-center justify-between w-full h-10 pl-5 pr-3 rounded-b-none bg-gradient-to-r from-neutral-700/95 via-neutral-300 to-neutral-700/95 rounded-2xl shadow-center shadow-neutral-950/70">
                  <div className="flex space-x-3">
                    <div className="bg-red-400 rounded-full size-3 shadow-center shadow-red-500"></div>
                    <div className="rounded-full size-3 shadow-center shadow-yellow-400 bg-yellow-500/90"></div>
                    <div className="rounded-full size-3 shadow-center shadow-green-400 bg-green-500/90"></div>
                  </div>
          ...
          <div className="flex flex-col justify-center w-full h-full px-6">
            <motion.div
              ...
              transition={FramerTransition}
            >
              <SectionTitle className="mt-12 mb-7">
